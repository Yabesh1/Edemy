...
const Companies = () => {
  return (
    <div className='pt-16'>
        ...
        <div className='flex flex-wrap items-center gap-6 justify-center md:gap-16 md:mt-10 mt-5'>
            ...
            <img src={assets.accenture_logo} alt="accrnture" className='w-20 md:w-28'/>
